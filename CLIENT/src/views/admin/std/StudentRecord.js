...
import { Row, Col, Card, CardBody, CardTitle,  Spinner, Button, Form } from "reactstrap";
...
const Index = () => {
        ...
        rows: stdData.map(std => ({
            ...
            action: (
                <div className="flex-center">
                    <Button className="me-1" type="submit" color="danger" size="sm" onClick={() => handleDelete(std._id)}>
                        Delete
                    </Button>
                    <Button type="submit" color="info" size="sm" onClick={() => handleEdit(std._id)}>
                        Edit
                    </Button>
                </div>
            )
    ...
    const handleDelete = (stdId) => {
        ...
        axios.delete(`${BASE_URL}/api/v1/users/student/delete/${stdId}`)
            .then((res) => {
    ...
    return (
        <Box pt={{ base: "130px", md: "80px", xl: "80px" }}>
                            ...
                            <Col className="col-12">
                                <Card>
                                    <CardBody>
                                        ...
                                        {!loading
                                            ? <MDBDataTable striped small responsive hover bordered data={data} noRecordsFoundLabel="No records found message || Select hostel" />
            ...
            <EditModal isOpen={isOpen} toggle={toggleModal} data={updateData} request="student" />
        </Box>
    );
};
